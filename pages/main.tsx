...
function LightPathApp() {
  ...
  const dialogContent = {
    teacher: <><h3>이렇게 풀어요</h3><ol><li>장면에서 광원·장치·표적을 찾아요.</li><li>빛길을 예상하고 장치를 골라요.</li><li>노란 선을 따라가며 본 것을 설명해요.</li></ol><p>수업 전후 실제 거울·렌즈 관찰과 연결해 주세요. 앱은 개념을 준비하고 정리하는 화면 활동입니다.</p><ul><li>결과를 보기 전에 빛길을 예상했는지</li><li>직진·반사·굴절을 장치와 연결하는지</li><li>실제 실험은 교사 안내가 필요함을 아는지</li></ul></>,
