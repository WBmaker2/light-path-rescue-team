...
export const metadata: Metadata = {
  metadataBase: new URL("https://wbmaker2.github.io/light-path-rescue-team/"),
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="ko"><head><link rel="icon" href="/favicon.svg" /></head><body>{children}</body></html>;
}
