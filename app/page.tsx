...
export default function Home() {
  ...
  const dialogContent = {
    ...
    model: <><p>화면의 노란 선은 실제로 보이는 빛이 아니라 진행 방향을 나타낸 가상 표시입니다.</p><p>평면거울은 빛길의 방향을 바꾸는 장면만 보여 줘요. 이 화면은 나란히 들어오는 세 빛줄기가 모이는 장면만 보여 줘요.</p><p><strong>안전:</strong> 강한 빛이나 햇빛을 눈에 비추거나 렌즈로 모으지 않습니다.</p></>,
