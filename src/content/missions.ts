...
export const MISSIONS: MissionDefinition[] = [
  {
    ...
    predictions: [{ id: "visible", label: "빛이 블록과 관찰창까지 이어진 장면" }, { id: "dark", label: "광원이 꺼진 장면" }, { id: "blocked", label: "빛이 막힌 장면" }],
  ...
  },
  {
    ...
    predictions: [{ id: "straight", label: "빛이 곧게 통과할 거예요" }, { id: "up", label: "빛이 위로 휠 거예요" }, { id: "down", label: "빛이 아래로 휠 거예요" }],
  ...
  },
  {
    ...
    setups: [{ id: "slot-a-down", label: `슬롯 A · ${MIRROR_ORIENTATION_LABELS.slash} 방향 거울` }, { id: "slot-a-up", label: `슬롯 A · ${MIRROR_ORIENTATION_LABELS.backslash} 방향 거울` }, { id: "slot-b-up", label: `슬롯 B · ${MIRROR_ORIENTATION_LABELS.backslash} 방향 거울` }],
    predictions: [{ id: "reflect", label: "거울에서 표지판 쪽으로 바뀔 거예요" }, { id: "wall", label: "직진하다 벽에서 멈출 거예요" }, { id: "through", label: "거울을 통과할 거예요" }],
  ...
  },
  {
    ...
    setups: [{ id: "both-turn", label: `거울 A ${MIRROR_ORIENTATION_LABELS.backslash} · 거울 B ${MIRROR_ORIENTATION_LABELS.slash}` }, { id: "first-only", label: `거울 A ${MIRROR_ORIENTATION_LABELS.backslash}만 선택` }, { id: "wrong-turn", label: `거울 A ${MIRROR_ORIENTATION_LABELS.slash} · 거울 B ${MIRROR_ORIENTATION_LABELS.backslash}` }],
    predictions: [{ id: "twice", label: "두 번 방향이 바뀔 거예요" }, { id: "once", label: "한 번만 방향이 바뀔 거예요" }, { id: "gone", label: "거울 사이에서 사라질 거예요" }],
  ...
  },
  {
    ...
    predictions: [{ id: "focus", label: "렌즈 뒤에서 빛이 모일 거예요" }, { id: "parallel", label: "그대로 평행할 거예요" }, { id: "mirror", label: "거울처럼 한쪽으로 꺾일 거예요" }],
  ...
  },
  {
    ...
    request: "잠망경·돋보기·카메라의 거울과 렌즈 역할을 한 번에 연결해요.", setupLabel: "세 장치 결합 연결",
    ...
    predictions: [{ id: "uses", label: "장치마다 쓰는 빛의 성질이 다를 거예요" }, { id: "same", label: "모든 장치가 같은 방식일 거예요" }, { id: "none", label: "빛의 성질과 관계없을 거예요" }],
