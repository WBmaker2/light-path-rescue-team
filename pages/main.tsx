...
function LightPathApp() {
  ...
  const dialogContent = {
    teacher: <><h3>이렇게 풀어요</h3><ol><li>그림에서 광원·장치·표적을 찾고 <strong>찾았어요</strong>를 눌러요.</li><li>빛길을 보기 전에 예상 하나를 골라요.</li><li>빛길이 이어지도록 거울이나 렌즈 하나를 골라요.</li><li><strong>빛길 확인</strong>을 누르고 노란 선을 하나씩 따라가요.</li><li>빛길에서 본 이유를 고르고, 틀리면 힌트를 읽어 장치를 다시 골라요.</li></ol><p>수업 전후 실제 거울·렌즈 관찰과 연결해 주세요. 앱은 개념을 준비하고 정리하는 화면 활동입니다.</p><ul><li>결과를 보기 전에 빛길을 예상했는지</li><li>직진·반사·굴절을 장치와 연결하는지</li><li>실제 실험은 교사 안내가 필요함을 아는지</li></ul></>,
